...
PAPER_LEAN_CELLS = {2: 2, 3: 4, 4: 8}    # k -> threshold n, kernel-checked
PAPER_LEAN_UNFORMALISED = (5,)           # k values with NO stabilityAt theorem
...
def V12():
    ...
    for k, thr in sorted(PAPER_LEAN_CELLS.items()):
        name = {2: "stabilityAt_two", 3: "stabilityAt_three",
                4: "stabilityAt_four"}[k]
        got = lean_hyp_threshold(sk4 if k == 4 else sk, name)
        want = thr
